...
class BaseModelForImageAuthorship(pl.LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        self.logger.experiment.add_scalars('loss', {'train': training_epoch_loss}, self.current_epoch)
        self.train_step_outputs.clear()
        

    def on_validation_epoch_end(self):
        validation_epoch_loss = stack(self.validation_step_outputs).mean()
        self.logger.experiment.add_scalars('loss', {'valid': validation_epoch_loss}, self.current_epoch)
